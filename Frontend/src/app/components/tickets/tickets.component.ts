...
import { ActionButtonComponent } from '../admin/tickets/action-button/action-button.component';
...
@Component({
  ...
  standalone: true,
  imports: [NavbarComponent, SidebarComponent, CommonModule, AgGridAngular, RouterLink],
...
export class TicketsComponent {
  ...
  getTickets(): void {
    this.ticketsService.getTicketsbyUserId(this.userID).subscribe({
      next: (response) => {
        this.tickets = response.sort((a: any, b: any) => a.id - b.id);  // Ordenar tickets por ID
